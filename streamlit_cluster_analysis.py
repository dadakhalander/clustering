...
# --- Section 1: Cluster Analysis of Existing Data ---
st.header("Cluster Analysis of Existing Data")
...
# Show cluster distribution and first few rows of clustered data
cluster_distribution = clustered_data['Cluster'].value_counts().sort_index()
st.subheader("Cluster Distribution:")
st.bar_chart(cluster_distribution)

st.subheader("First 5 Rows of Clustered Data:")
st.dataframe(clustered_data.head())

# --- Section 2: New Customer Data Analysis ---
st.header("New Customer Data Analysis")
